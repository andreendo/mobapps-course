...
public class ShowMessagesFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        mainViewModel.getShowMessageError().observe(getViewLifecycleOwner(), errorMsg -> {
            if (errorMsg.equals(""))
                return;
            binding.boardIdEditText.setError(errorMsg);
        });
        ...
        binding.showMessagesButton.setOnClickListener(v -> {
            int iid = -1;
            if (! binding.boardIdEditText.getText().toString().equals(""))
